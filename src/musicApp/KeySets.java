...
public class KeySets
{
	public static void addOctave1(ArrayList<Key> keys)
	{
		...
		keys.add(new Key(Key.KEY_CENTER, KeyEvent.VK_H, "A Key", "1", ClipLoader.loadClip("/Sound Assets/Key A_edit.wav")));
	...
	{
		keys.add(new Key(Key.KEY_LEFT, KeyEvent.VK_K, "C Key", "2", ClipLoader.loadClip("/Sound Assets/Key A_edit.wav")));
		keys.add(new Key(Key.KEY_BLACK, KeyEvent.VK_O, "C# Key", "2", ClipLoader.loadClip("/Sound Assets/Key B.wav")));
		keys.add(new Key(Key.KEY_CENTER, KeyEvent.VK_L, "D Key", "2", ClipLoader.loadClip("/Sound Assets/Key B.wav")));
		keys.add(new Key(Key.KEY_BLACK, KeyEvent.VK_P, "D# Key", "2", ClipLoader.loadClip("/Sound Assets/Key B.wav")));
		keys.add(new Key(Key.KEY_RIGHT, KeyEvent.getExtendedKeyCodeForChar(';'), "E Key", "2", ClipLoader.loadClip("/Sound Assets/Key A_edit.wav")));
		keys.add(new Key(Key.KEY_LEFT, KeyEvent.VK_QUOTE, "F Key", "2", ClipLoader.loadClip("/Sound Assets/Key B.wav")));
		keys.add(new Key(Key.KEY_BLACK, KeyEvent.getExtendedKeyCodeForChar(']'), "F# Key", "2", ClipLoader.loadClip("/Sound Assets/Key B.wav")));
